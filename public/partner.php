...
{
    try {
        $sql = "SELECT id, name, category, logo, website, description FROM partners ORDER BY category, name ASC";
        $res = q($sql);
        $partners = pg_fetch_all($res) ?: [];
        return $partners;
    } catch (RuntimeException $e) {
        error_log("Gagal mengambil partners: " . $e->getMessage());
        return [];
    }
}
...
<head>
    ...
    <title>Our Partners - Lab AI Polinema</title>
