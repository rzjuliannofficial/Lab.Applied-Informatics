...
<body>
   ...
   <?php include __DIR__ . '/../components/header.php'; ?>
<?php include __DIR__ . '/../components/scope.php'; ?>
<?php include __DIR__ . '/../components/news.php'; ?>
<?php include __DIR__ . '/../components/product.php'; ?>
<?php include __DIR__ . '/../components/member.php'; ?>
<?php include __DIR__ . '/../components/fasilities.php'; ?>
<?php include __DIR__ . '/../components/publication.php'; ?>
