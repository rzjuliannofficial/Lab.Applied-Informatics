...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-user-plus mr-2 text-blue-600"></i> Tambah Publikasi Lab
        </h1>
        <a href="/admin/PublikasiLab" class="text-gray-500 hover:text-gray-700 transition flex items-center">
    ...
    <form action="/admin/PublikasiLab/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="judul" class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Masukkan judul publikasi">
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Kategori</label>
                    <input type="text" name="kategori" class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Contoh: Penelitian, Jurnal, Kegiatan Lab">
                </div>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="deskripsi" rows="4" class="w-full px-4 py-2 border border-gray-300 rounded-lg" placeholder="Tuliskan deskripsi singkat..."></textarea>
                </div>
        ...
        <div class="bg-gray-50 px-8 py-5 border-t border-gray-200 flex items-center justify-end space-x-3">
            <a href="/admin/PublikasiLab" class="px-5 py-2 rounded-lg border border-gray-300 text-gray-700 font-medium hover:bg-gray-100 transition">
                Batal
            </a>
            <button type="submit" class="px-6 py-2 rounded-lg bg-blue-600 text-white font-bold shadow-md hover:bg-blue-700 transition">
