...
<h1 class="text-2xl font-bold mb-6">Tambah Kekayaan Intelektual</h1>
...
<form action="/admin/KekayaanIntelektual/store" method="POST"
    ...
    <input type="text" name="no_permohonan" class="w-full p-2 border rounded mb-4">

    <label class="block font-semibold mb-1">Tahun</label>
    <input type="text" name="tahun" class="w-full p-2 border rounded mb-4">
