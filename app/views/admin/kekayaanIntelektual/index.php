        ...
        <tr class="hover:bg-gray-50">
            ...
            <td class="p-3 border">
                <div class="flex items-center justify-center gap-2">
                    ...
                    <a href="/admin/KekayaanIntelektual/edit/<?= $r['id'] ?>" class="flex items-center gap-1 px-2 py-1 text-xs font-medium 
                  ...
                  rounded hover:bg-yellow-200 transition">
                    ...
                    <a href="/admin/KekayaanIntelektual/delete/<?= $b['id'] ?>" onclick="return confirm('Hapus berita ini?')"
