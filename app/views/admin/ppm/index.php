...
<h1 class="text-2xl font-bold mb-6">PPM (Pengabdian Kepada Masyarakat)</h1>

<a href="/admin/Ppm/create" class="bg-blue-600 text-white px-4 py-2 rounded">Tambah PPM</a>
