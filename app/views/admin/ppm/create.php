...
<div class="max-w-5xl mx-auto">
    ...
    <form action="/admin/Ppm/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-gray-50 px-8 py-5 border-t border-gray-200 flex items-center justify-end space-x-3">
            ...
            <button type="submit"
                class="px-6 py-2 rounded-lg bg-blue-600 text-white font-bold shadow-md hover:bg-blue-700 
