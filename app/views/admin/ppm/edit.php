                ...
                <div>
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex-shrink-0">
                            <?php if (!empty($ppm['foto_url'])): ?>
                                <img src="<?= htmlspecialchars($ppm['foto_url']) ?>" class="h-16 w-16 rounded-full object-cover border border-gray-200">
                            <?php else: ?>
