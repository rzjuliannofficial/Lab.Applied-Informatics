...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-user-plus mr-2 text-blue-600"></i> Tambah Publikasi Dosen
        </h1>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div class="space-y-6">
                <h3 class="text-lg font-semibold text-gray-700 border-b pb-2 mb-4">
                    <i class="fas fa-book mr-2 text-gray-400"></i> Informasi Publikasi
                </h3>

                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Dosen</label>
                    <select name="id_dosen" required class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white">
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="kategori"
                        class="w-full px-4 py-2 border border-gray-300 rounded-lg"
                        placeholder="Contoh: Jurnal, Konferensi, Seminar...">
                </div>
