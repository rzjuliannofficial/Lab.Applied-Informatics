...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-edit mr-2 text-yellow-600"></i> Edit Publikasi Dosen
        </h1>
    ...
    <form action="/admin/PublikasiDosen/update/<?= $publikasi['id'] ?>" method="POST" enctype="multipart/form-data">
