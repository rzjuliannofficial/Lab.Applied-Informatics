...
<div class="max-w-5xl mx-auto">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-edit mr-2 text-yellow-600"></i> Edit Riset Dosen
        </h1>
        <a href="/admin/RisetDosen" class="text-gray-500 hover:text-gray-700 transition flex items-center">
    ...
    <form action="/admin/RisetDosen/update/<?= $riset['id'] ?>" method="POST" enctype="multipart/form-data">        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">Judul Riset</label>
                ...
                <div>
                    ...
                    <?php if ($riset['foto_url']): ?>
                        ...
                        <img src="<?= htmlspecialchars($riset['foto_url']) ?>"
