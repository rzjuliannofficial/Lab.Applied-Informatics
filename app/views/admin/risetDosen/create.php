...
<h1 class="text-2xl font-bold mb-6">Tambah Riset Dosen</h1>
...
<form action="/admin/RisetDosen/store" method="POST"
    ...
    <input type="text" name="sumber_dana" class="w-full p-2 border rounded mb-4">

    <label class="block font-semibold mb-1">Foto/Dokumentasi Riset</label>
