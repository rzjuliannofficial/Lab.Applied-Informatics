...
<div class="max-w-5xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-bold text-gray-800">
            <i class="fas fa-user-plus mr-2 text-blue-600"></i> Tambah Partner
        </h1>
        <a href="/admin/Partner" class="text-gray-500 hover:text-gray-700 transition flex items-center">
...
<div class="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-100">
    <form action="/admin/Partner/store" method="POST" enctype="multipart/form-data">
        ...
        <div class="bg-gray-50 px-8 py-5 border-t border-gray-200 flex justify-end space-x-3">
            ...
            <button type="submit"
                    class="px-6 py-2 rounded-lg bg-blue-600 text-white font-bold shadow-md 
